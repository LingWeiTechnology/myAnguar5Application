...
public class MyAnguar5ApplicationApp {

    private static final Logger log = LoggerFactory.getLogger(MyAnguar5ApplicationApp.class);

    private final Environment env;

    public MyAnguar5ApplicationApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes myAnguar5Application.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(MyAnguar5ApplicationApp.class);
